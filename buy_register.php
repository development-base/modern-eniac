...
<form action="" method="POST">
	...
	<table>
		...
		<tr><td>Username:</td><td><input type="username" name="username" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="ex. john@gmail.com" autocomplete="off" required></td>
	...
	elseif($contact_no==$row['contact_no'])
		{
			...
			echo "<script type=\"text/javascript\">
					alert(\"Registration Successful you can now login for purchasing\");  
				</script>";
