					...
					<div class="nav">
						<nav ></br></br>
						  <div class="grid-container">
							<a href="buy.php"><li class="view">BACK</li></a>
...
?>					
				<center><table class="my_prod">	
					...
					<tr><td>owner: <?php echo $row['fname'];?> <?php echo $row['mi'];?>. <?php echo $row['lname'];?></td></tr></tr>
					...
					<tr><td colspan="2"><button class="mov"><a href="buy.php">BACK</a></button></a></td></tr>
				</table></center>
<?php							}	
							}	
						}$mysqli->close();	
