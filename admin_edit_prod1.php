						...
						<center><div class="form">
								<form action="admin_product_update.php" method="POST">
									<table class="my_prod">	
										...
										<tr><td>HDD:</td><td class="tex">		<input type="text" value="<?php echo $row['HDD'];?>"  name="HDD" maxlength="14"></td></tr>
										...
										<tr><td>Price:</td>				<td class="tex"><input type="text" value="<?php echo $row['price'];?>" name="price" maxlength="12"></td></tr>
